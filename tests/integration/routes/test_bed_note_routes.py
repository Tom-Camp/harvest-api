...
class TestBedNoteRoutes:
    ...
    async def test_create_bed_note(
        ...
        if isinstance(garden, Garden):
            ...
            response = await client.post(
                url="/api/bed-notes/",
                json={"note": "this is a bed note", "bed_id": str(bed_id)},
                headers=headers,
            )
            data = response.json()
    ...
    @pytest.mark.asyncio
    async def test_get_bed_note_unauthenticated(
        self,
        client: AsyncClient,
        default_user: dict[str, User],
        default_gardens: dict[str, Garden],
    ...
    @pytest.mark.asyncio
    async def test_get_bed_note_bad_id(
        self,
        client: AsyncClient,
        default_user: dict[str, User],
    ):
